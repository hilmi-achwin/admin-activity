 ...
 <form id="profileForm" method="post" class="form-horizontal">
    ...
    <section data-step="0">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <input type="text"  class="form-control" name="edi_number" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <label class="checkbox-inline">
                    <input type="checkbox" name="enabler" value="X2"> X2 <br>
                </label>
                <label class="checkbox-inline">
                    <input type="checkbox" name="enabler" value="EXTREME" > EXTREME <br>
                </label>
                <label class="checkbox-inline">
                    <input type="checkbox" name="enabler" value="Lainnya"> Lainnya <br>               
                </label>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-5">
                    <input type="checkbox" name="jenis_perusahaan" value="Eksportir"> Eksportir <br>
                    <input type="checkbox" name="jenis_perusahaan" value="Importir" >Importir<br>
                    <input type="checkbox" name="jenis_perusahaan" value="PPJK"> PPJK <br>
                    <input type="checkbox" name="jenis_perusahaan" value="Eksportir dan Importir"> Eksportir dan Importir <br>
                    <input type="checkbox" name="jenis_perusahaan" value="Shipping Line" > Shipping Line<br>
                    <input type="checkbox" name="jenis_perusahaan" value="Airline"> Airline<br>
                    <input type="checkbox" name="jenis_perusahaan" value="Bank interface"> Bank<br>
                    <input type="checkbox" name="jenis_perusahaan" value="lainnya"> Lainnya<br>
            </div>
        </div>
